...
const docTemplate = `{
    ...
    "paths": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/service.GetArtResponse"
                            }
                        }
                    },
                    "500": {
        ...
        "/api/arts/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "New art information",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/service.SaveArtBody"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/service.AuthorizationBody"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/service.RegistrationBody"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/service.UpdateTokensBody"
                        }
                    }
                ],
                "responses": {
                    "202": {
                        "description": "Accepted",
                        "schema": {
                            "$ref": "#/definitions/service.UpdateTokensResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/service.GetAuthorByIdResponse"
                            }
                        }
                    },
                    "500": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/service.SaveAuthorBody"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/authors/{id}/avatar/{fileName}": {
            "get": {
                "consumes": [
                    "application/json"
                ],
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/service.CreateCategoryBody"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/service.AddAuthorsBody"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/categories/{id}/preview-file": {
            "put": {
                "consumes": [
                    "application/json"
                ],
        ...
        "/api/categories/{id}/preview-file/{fileName}": {
            "get": {
                "consumes": [
                    "application/json"
                ],
